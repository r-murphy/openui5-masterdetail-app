sap.ui.define([
  ...
  opaTest("Should see a global busy indication while loading the metadata", (Given, When, Then) => {
    // Arrangements
  ...
  opaTest("Should see a busy indication on the master and detail after loading the metadata", (Given, When, Then) => {
    // Arrangements
