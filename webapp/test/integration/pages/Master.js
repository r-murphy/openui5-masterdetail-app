  ...
  Opa5.createPageObjects({
    onTheMasterPage : {
      ...
      actions : {
        ...
        iWaitUntilTheFirstItemIsSelected() {
          return this.waitFor({
            id : "list",
            viewName : sViewName,
            matchers(oList) {
        ...
        iSelectListItemInViewSettingsDialog(sListItemTitle) {
          return this.waitFor({
        ...
        iPressResetInViewSelectionDialog() {
          return this.waitFor({
            searchOpenDialogs : true,
            controlType : "sap.m.Button",
        ...
        iPressItemInSelectInFooter(sSelect, sItem) {
          return this.waitFor({
            id : sSelect,
            viewName : sViewName,
            success: (oSelect) => {
        ...
        iRememberTheIdOfListItemAtPosition(iPosition) {
          return this.waitFor({
            id : "list",
            viewName : sViewName,
            matchers(oList) {
        ...
        iRememberAnIdOfAnObjectThatsNotInTheList() {
        ...
        iPressOnTheObjectAtPosition(iPosition) {
          return this.waitFor({
            id : "list",
            viewName : sViewName,
            matchers(oList) {
        ...
        iRememberTheListItem(oListItem) {
      ...
      assertions : {
        ...
        theListGroupShouldBeFilteredOnUnitNumberValue20OrLess() {
          return this.theListShouldBeFilteredOnUnitNumberValue(20, false, {iLow : 1, iHigh : 2});
        },

        theListShouldContainAGroupHeader() {
          return this.waitFor({
        ...
        theListShouldContainOnlyFormattedUnitNumbers() {
        ...
        theListShouldBeSortedAscendingOnUnitNumber() {
          return this.theListShouldBeSortedAscendingOnField("UnitNumber");
        },

        theListShouldBeSortedAscendingOnName() {
          return this.theListShouldBeSortedAscendingOnField("Name");
        },

        theListShouldBeSortedAscendingOnField(sField) {
        ...
        theListShouldBeFilteredOnUnitNumberValue(iThreshhold, bGreaterThan, oRange) {
        ...
        theMasterListShouldBeFilteredOnUnitNumberValueMoreThanTheGroupBoundary(){
          return this.theListShouldBeFilteredOnUnitNumberValue(iGroupingBoundary, true);
        },

        theMasterListShouldBeFilteredOnUnitNumberValueLessThanTheGroupBoundary(){
        ...
        theListShowsOnlyObjectsWithTheSearchStringInTheirTitle() {
          this.waitFor({
            id : "list",
            viewName : sViewName,
            matchers : new AggregationFilled({name : "items"}),
        ...
        theListShouldHaveNEntries(iObjIndex) {
          return this.waitFor({
            id : "list",
            viewName : sViewName,
        ...
        theHeaderShouldDisplayAllEntries() {
          return this.waitFor({
            id : "list",
            viewName : sViewName,
            success(oList) {
        ...
        theRememberedListItemShouldBeSelected() {
          this.waitFor({
            id : "list",
            viewName : sViewName,
            matchers(oList) {
